...
dataSimUnitsFull_biennial<-function(dataIn,modIn,declineRate,nyrs,nvisits){
...
#generate sequence of odd numbers 1 through n
grab.odds<-c(seq(1,nyrs,2))

#select every other column
sim.N.out.3<-sim.N.out.2[,grab.odds]

det.out.5<-det.out.4[grab.odds]


return(list(detList=det.out.4, covList=covList, N=sim.N.out.3, cell=cell.2))
