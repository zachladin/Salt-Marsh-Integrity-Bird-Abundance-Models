...
dividePointsHalf<-function(dataIn){
  ...
  for(i in 1:length(hexagonList.even)){
    ...
    message(paste("Dividing data within ",hexagonName," into 2 randomized groups.",sep=""))
  ...
  write.csv(group1.out, file=paste(getwd(),"Data","Data_Half","Group1_data_2011-2015_half1.csv",sep="/"),row.names=FALSE)
  write.csv(group2.out, file=paste(getwd(),"Data","Data_Half","Group2_data_2011-2015_half2.csv",sep="/"), row.names=FALSE)
