...
dividePointsThirds<-function(dataIn){
  ...
  group3.2rand<-subset(group3.out, c(new.pointNum==1145 | new.pointNum==1873))
  ...
  write.csv(group1.out, file=paste(getwd(),"Data","Data_Thirds","Group1_data_2011-2015.csv",sep="/"),row.names=FALSE)
  write.csv(group2.out.new, file=paste(getwd(),"Data","Data_Thirds","Group2_data_2011-2015.csv",sep="/"), row.names=FALSE)
  write.csv(group3.out.new, file=paste(getwd(),"Data","Data_Thirds","Group3_data_2011-2015.csv",sep="/"), row.names=FALSE)
